...
[<assembly: AssemblyTitleAttribute("Informedica.SqlUtils.Lib.Tests")>]
[<assembly: AssemblyProductAttribute("Informedica.SqlUtils.Lib")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Informedica.SqlUtils.Lib.Tests"
    let [<Literal>] AssemblyProduct = "Informedica.SqlUtils.Lib"
